...
export const FALLBACK_TRACE: UniversalFinancialTrace = {
  ...
  execution_tx_hash: 'sim_tx_projected_arc_settlement',
  ...
  steps: [
    ...
    { step_number: 10, stage: 'VAULT', status: 'SIMULATED', reference_id: '0x10A8fA3D110a12e8c5Ff68202d0b5A1a65B49852', description: 'AgentVault smart contract verified daily cap and authorized transfer (SIMULATION -- NOT DEPLOYED ON MAINNET)', timestamp: new Date(Date.now() - 8 * 60000).toISOString() },
    { step_number: 11, stage: 'ARC', status: 'PROJECTED', reference_id: 'sim_tx_projected_arc_settlement', description: 'Arc settlement payload projected for Chain ID 5042 (SIMULATION -- ZERO ON-CHAIN TRANSACTIONS BROADCAST)', hash: 'sim_tx_projected_arc_settlement', timestamp: new Date(Date.now() - 5 * 60000).toISOString() },
